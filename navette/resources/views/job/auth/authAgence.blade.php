                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="lieu" id="lieu" placeholder="Lieu de l'agence"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="re_pass" id="re_pass" placeholder="adresse email"/>
                            </div>
                            <div class="form-group">
                                <label for="re-pass"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="agree-term" class="label-agree-term"><span><span></span></span>J'accepte les politiques du site</label>                            </div>
                            <div class="form-group form-button">
                                <a class="btn btn-primary form-submit" type="submit" role="button" style=" text-decoration: none;">S'inscrire</a>
                            </div>
