            ...
            <div class="container">
                <div class="row g-2">
                    <div class="col-md-10">
                        <div class="row g-2">
                            <div class="col-md-3">
                                <input type="text" class="form-control border-0" placeholder="Lieu de Départ" />
                            </div>
                            <div class="col-md-3">
                                <input type="text" class="form-control border-0" placeholder="Lieu de D'arrivé" />
                            </div>
                            <div class="col-md-3">
                                <input type="text" class="form-control border-0" placeholder="Date" />
                            </div>
                            <div class="col-md-3">
                                <input type="text" class="form-control border-0" placeholder="Heure" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        ...
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-primary" href="job-detail.html">Réserver</a>
                                        </div>
                            ...
                            <div class="job-item p-4 mb-4">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-primary" href="/job-list.html">Réserver</a>
                                        </div>
                                        <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i>Date Line: 01 Jan, 2045</small>
                                    </div>
                                </div>
